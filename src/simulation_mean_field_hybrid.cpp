//
//  simulation_mean_field_hybrid.cpp
//
//
...
//  The mean field solution is partly included in the quadratic part of the
//  model. In this way, interactions via the quartic term are included only
//  partially, with the remaining component begin added in mean field.
